...
implemented on a page or a post. It contains a real-time AJAX calculation option, which degrades
gracefully on older browsers and uses a button to calculate repayments.
...
You need to add the [finance_calculator] shortcode to the body of the post/page in the editor's
HTML mode.
